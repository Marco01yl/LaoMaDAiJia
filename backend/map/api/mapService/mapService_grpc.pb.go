...
func (c *mapServiceClient) GetDrivinginfo(ctx context.Context, in *GetDrivingInfoReq, opts ...grpc.CallOption) (*GetDrivingInfoReply, error) {
...
func (UnimplementedMapServiceServer) GetDrivinginfo(context.Context, *GetDrivingInfoReq) (*GetDrivingInfoReply, error) {
