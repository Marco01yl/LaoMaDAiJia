...
type GetVerifyCodeRequest struct {
	...
	Type   TYPE   `protobuf:"varint,2,opt,name=type,proto3,enum=api.verfyCode.TYPE" json:"type,omitempty"`
}
...
var file_api_verifyCode_verifyCode_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x0d, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x65, 0x72, 0x66, 0x79, 0x43, 0x6f, 0x64, 0x65,
	0x22, 0x28, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x43, 0x6f, 0x64,
	0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0x57, 0x0a, 0x14, 0x47, 0x65,
	...
	,
}
...
var file_api_verifyCode_verifyCode_proto_goTypes = []interface{}{
	(TYPE)(0),                    // 0: api.verfyCode.TYPE
	(*GetVerifyCodeReply)(nil),   // 1: api.verfyCode.GetVerifyCodeReply
	(*GetVerifyCodeRequest)(nil), // 2: api.verfyCode.GetVerifyCodeRequest
}
var file_api_verifyCode_verifyCode_proto_depIdxs = []int32{
	0, // 0: api.verfyCode.GetVerifyCodeRequest.type:type_name -> api.verfyCode.TYPE
	2, // 1: api.verfyCode.VerifyCode.GetVerifyCode:input_type -> api.verfyCode.GetVerifyCodeRequest
	1, // 2: api.verfyCode.VerifyCode.GetVerifyCode:output_type -> api.verfyCode.GetVerifyCodeReply
